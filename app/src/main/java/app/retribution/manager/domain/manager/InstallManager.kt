package app.retribution.manager.domain.manager
...
import app.retribution.manager.installer.session.InstallService
    ...
    fun uninstall() {
        current?.let {
            val callbackIntent = Intent(context, InstallService::class.java).apply {
                action = "Retribution.actions.ACTION_UNINSTALL"
            }
