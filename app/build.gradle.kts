...
android {
    namespace = "app.retribution.manager"
    compileSdk = 34

    defaultConfig {
        applicationId = "app.retribution.manager"
        minSdk = 28
        targetSdk = 34
        ...
        buildConfigField("String", "MOD_NAME", "\"Retribution\"")
        ...
        buildConfigField("String", "MODDED_APP_ICON_URL", "\"https://i.allyapp.cc/raw/gDH8Eowi.png\"")
